      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-40 pb-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pb-20 mt-16">
          ...
          <div className="mt-8">
            <a
              href="/wayroleta"
              className="group relative block w-full max-w-2xl mx-auto p-6 bg-gradient-to-r from-yellow-400/20 via-orange-500/20 to-red-500/20 backdrop-blur-sm border-2 border-yellow-400/30 rounded-2xl hover:border-yellow-400/50 transition-all duration-300 hover:scale-105"
            >
              <div className="flex items-center justify-center gap-4">
                ...
                <div className="text-center">
                  <h3 className="text-xl font-black text-white mb-1">ROLETA PREMIADA</h3>
                  <p className="text-yellow-300 font-bold">Ganhe até 50% OFF • Clique aqui!</p>
                </div>
